...
export default function Header({ data }: HeaderProps) {
  ...
  return (
    <header className="h-10 bg-bg-card border-b border-border flex items-center px-4 gap-6">
      {/* Page title area */}
      ...
      <div className="flex items-center gap-2">
        <span className="text-2xs text-text-dim font-mono">LAST UPDATE</span>
        <span className="text-xs font-mono text-green">{exportedAt}</span>
      </div>
